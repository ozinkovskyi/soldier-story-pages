        ...
        >
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">
              Зв'яжіться з <span className="text-crimson">автором</span>
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-sm font-sans text-muted-foreground mb-2">Ваше ім'я</label>
            ...
            <div>
              <label className="block text-sm font-sans text-muted-foreground mb-2">Email</label>
              <input type="email" maxLength={255} value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })}
                className="w-full px-4 py-3 bg-card border border-border rounded font-sans text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring transition-colors"
                placeholder="your@email.com" />
            </div>
            <div>
              <label className="block text-sm font-sans text-muted-foreground mb-2">Повідомлення</label>
